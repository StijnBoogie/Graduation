...
const SCENARIOS = {
  ok:     { key: 'ok',     label: 'Normal',           rate: 0.3, baseTemp: 28, name: 'NORMAL',
            ...
            range: { head: 'Temperature is ', verdict: 'behaving normally', tail: ', between the 20 – 35 °C range expected while charging.', note: 'This is the temperature a healthy battery reaches while charging.' },
  ...
  alert1: { key: 'alert1', label: 'Small anomaly',    rate: 1.0, baseTemp: 44, name: 'SMALL ANOMALY',
            ...
            range: { head: 'Temperature is ', verdict: 'above', tail: ' the normal range of 20 – 35 °C.', note: 'A normal charge stays below 35 °C. This reading is higher than expected.' },
  ...
  alert2: { key: 'alert2', label: 'Elevated risk',    rate: 2.0, baseTemp: 56, name: 'ELEVATED RISK',
            ...
            range: { head: 'Temperature is ', verdict: 'well above', tail: ' the normal range of 20 – 35 °C.', note: 'Far above the 35 °C a normal charge should stay under.' },
  ...
  red1:   { key: 'red1',   label: 'Developing danger', rate: 3.5, baseTemp: 76, name: 'DEVELOPING DANGER',
            ...
            range: { head: 'Temperature is ', verdict: 'dangerously above', tail: ' the normal range of 20 – 35 °C.', note: 'Approaching the point where thermal runaway becomes irreversible.' },
  ...
  red2:   { key: 'red2',   label: 'Imminent risk',    rate: 5.0, baseTemp: 96, name: 'IMMINENT RISK',
            ...
            range: { head: 'Temperature is ', verdict: 'critically above', tail: ' the normal range of 20 – 35 °C.', note: 'At or beyond the thermal-runaway threshold.' },
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <div>
            ...
            <div style={{
              ...
              fontSize: 62, lineHeight: 1, color: c.primary, letterSpacing: -2, marginTop: 6,
              fontVariantNumeric: 'tabular-nums', transition: 'color 0.8s ease',
            }}>
              {liveTemp.toFixed(1)}<span style={{ fontSize: 24, color: c.ink, opacity: 0.65 }}>°C</span>
            </div>
          </div>
        ...
        {/* Temperature range — what this reading means relative to expected behaviour */}
        <div style={{ marginTop: 16, paddingTop: 14, borderTop: `1px solid ${c.mid}` }}>
          <div style={{ fontSize: 10, fontFamily: 'JetBrains Mono, monospace', color: 'rgba(0,0,0,0.5)', letterSpacing: 0.8, textTransform: 'uppercase', marginBottom: 8 }}>This reading</div>
          <div style={{ fontSize: 16, color: c.ink, lineHeight: 1.4, letterSpacing: -0.2 }}>
            {range.head}<span style={{ color: c.primary, fontWeight: 600 }}>{range.verdict}</span>{range.tail}
          </div>
        </div>
      </div>
      ...
      {/* Temperature trend graph — support */}
      <div style={{
        background: 'rgba(255,255,255,0.7)', borderRadius: 20,
        border: `1px solid ${c.mid}`, padding: '16px 18px 12px', marginBottom: 12, backdropFilter: 'blur(8px)',
      }}>
        <div style={{ fontSize: 10, fontFamily: 'JetBrains Mono, monospace', color: c.ink, opacity: 0.7, letterSpacing: 1, textTransform: 'uppercase', fontWeight: 600, marginBottom: 10 }}>
