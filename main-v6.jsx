...
function App() {
  ...
  return (
    <div style={{
      ...
      {/* Moderator-only scenario switcher — shown ONLY on the home screen
          (the battery overview). Small and faint so the participant barely
          registers it. Hidden on setup, lockscreen and the monitoring detail
          screen. */}
      {!isSetup && screen === 'overview' && <ModeratorSwitcher />}
    </div>
  );
}
